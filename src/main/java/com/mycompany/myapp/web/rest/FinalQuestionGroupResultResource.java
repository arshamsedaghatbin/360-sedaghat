...
import com.mycompany.myapp.repository.FinalQuestionGroupResultRepository;
...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.FinalQuestionGroupResult}.
 */
@RestController
@RequestMapping("/api")
@Transactional
