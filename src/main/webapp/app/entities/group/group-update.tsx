...
export const GroupUpdate = (props: IGroupUpdateProps) => {
  ...
  const { groupEntity, employees, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="App.group.home.createOrEditLabel">Create or edit a Group</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : groupEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="group-name" type="text" name="name" />
              </AvGroup>
