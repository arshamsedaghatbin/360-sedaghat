    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="personalNumber">Personal Number</span>
          </dt>
          <dd>{employeeEntity.personalNumber}</dd>
          <dt>
            <span id="weight">Weight</span>
          </dt>
          <dd>{employeeEntity.weight}</dd>
          <dt>Group</dt>
          <dd>
            {employeeEntity.groups
              ? employeeEntity.groups.map((val, i) => (
                  <span key={val.id}>
                    <a>{val.id}</a>
                    {employeeEntity.groups && i === employeeEntity.groups.length - 1 ? '' : ', '}
                  </span>
                ))
              : null}
          </dd>
